...
?>
<!-- Campo para cadastro de informações que serão atribuídas a página de acesso "UpdateUsuarioAction.php -->
...
<div class="w3-container w3-round-xxlarge w3-display-middle w3-card-4 w3-twothird">
    ...
    <form class="w3-container" action="updateUsuarioAction.php" method="post">
        <div class="w3-section">
            ...
            <input class="w3-input w3-border w3-border-gray" type="text" placeholder="Digite a senha atual " name="txtNomeUsuario" 
            <?php echo 'required value="'.$valorPrevioNomeUsuario.'"'; ?> >
            
            <label style="font-weight: bold;">Nova Senha</label>
            <input class="w3-input w3-border w3-border-gray" type="text" placeholder="Informe o número do RG" name="txtRg" 
            <?php echo 'required value="'.$valorPrevioRg.'"'; ?> >

            <label style="font-weight: bold;">CPF</label>
            <input class="w3-input w3-border w3-border-gray" type="text" placeholder="Informe o número do CPF" name="txtCpf" 
            <?php echo 'required value="'.$valorPrevioCpf.'"'; ?> >
            
            <label style="font-weight: bold;">Logradouro</label>
            <input class="w3-input w3-border w3-border-gray" type="text" placeholder="Informe o nome do Logradouro" name="txtLogradouro" 
            <?php echo 'required value="'.$valorPrevioLogradouro.'"'; ?> >

            <label style="font-weight: bold;">Número</label>
            <input class="w3-input w3-border" type="text" placeholder="Informe o número" name="txtNumero" 
            <?php echo 'required value="'.$valorPrevioNumero.'"'; ?> >

            <label style="font-weight: bold;">CEP</label>
            <input class="w3-input w3-border" type="text" placeholder="Informe o CEP" name="txtCEP" 
            <?php echo 'required value="'.$valorPrevioCEP.'"'; ?> >

            <label style="font-weight: bold;">Cidade</label>
            <input class="w3-input w3-border" type="text" placeholder="Informe a Cidade" name="txtCidade" 
            <?php echo 'required value="'.$valorPrevioCidade.'"'; ?> >
